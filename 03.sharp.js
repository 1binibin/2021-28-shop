...
const files = [
  ...
  '211109_9c4dd6a3-6e9a-4d56-8077-7ac4ce7f42c0.jpg',
  '211109_81e2a275-6f92-436d-88ac-935581b12028.jpg',
];

async function start() {
  for (let v of files) {
    let loc = path.join(__dirname, 'storages', v.split('_')[0], 'thumb');
    v.thumb = await sharp(absPath(v)).resize(200).jpeg({ mozjpeg: true }).toFile(path.join(loc, v));
  }
}
